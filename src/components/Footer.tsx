    ...
    <div className="min-w-screen my-4 flex flex-col gap-4">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        <CardTitle className="text-center">
          ©︎ 2024. Feito com muito carinho por Leonardo Araujo Sarmento
        </CardTitle>
...
export const SocialMediaItems: TSocialMediaCard[] = [
  {
    name: "Instagram",
    icon: Instagram,
    link: "https://instagram.com/leonardo.a.sarmento",
  },
  {
    name: "Linkedin",
    icon: Linkedin,
    link: "https://linkedin.com/in/leonardo-araujo-sarmento",
  },
  { name: "Github", icon: Github, link: "https://github.com/LeonardoSarmento" },
  {
    name: "Gmail",
    icon: Mail,
    link: "mailto: leonardo.a.sarmento@gmail.com?subject=ThisIsMyFeedback&body=Hello!",
  },
];
